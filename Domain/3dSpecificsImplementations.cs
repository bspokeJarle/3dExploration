...
namespace Domain
{
    public class _3dSpecificsImplementations
    {
        ...
        public class TriangleMesh : ITriangleMesh
        {
            ...
            public Domain.IVector3 normal1
            {
                get => _normal1 ??= new Vector3();
                set => _normal1 = value;
            }

            public Domain.IVector3 normal2
            {
                get => _normal2 ??= new Vector3();
                set => _normal2 = value;
            }

            public Domain.IVector3 normal3
            {
                get => _normal3 ??= new Vector3();
                set => _normal3 = value;
            }

            public Domain.IVector3 vert1
            {
                get => _vert1 ??= new Vector3();
                set => _vert1 = value;
            }

            public Domain.IVector3 vert2
            {
                get => _vert2 ??= new Vector3();
                set => _vert2 = value;
            }

            public Domain.IVector3 vert3
            {
