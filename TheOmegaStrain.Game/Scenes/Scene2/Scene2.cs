...
namespace TheOmegaStrain.Game.Scenes.Scene2
{
    public class Scene2:IScene
    {
        ...
        public void SetupScene(I3dWorld world)
        {
            ...
            Surface.Create2DMap(30000,15000,GameMode, "Scene2SurfaceRecording_20260824_224730.retro");
            ...
            attackShip.ObjectOffsets = new Vector3 { x = 0, y = 0, z = -200 };
            attackShip.Rotation = new Vector3 { x =0, y = 0, z = 90 };
