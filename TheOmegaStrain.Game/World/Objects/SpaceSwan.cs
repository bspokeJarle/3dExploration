...
namespace TheOmegaStrain.Game.World.Objects
{
    public class SpaceSwan
    {
        ...
        public static List<ITriangleMeshWithColorAndTexture>? ParticlesDirectionGuide()
        {
            return new List<ITriangleMeshWithColorAndTexture>
            {
                CreateTriangleOutward(
                    new Vector3 { x = tailTipX - 19f, y =  4.5f, z =  1.2f },
                    new Vector3 { x = tailTipX - 19f, y = -4.5f, z =  1.2f },
                    new Vector3 { x = tailTipX - 19f, y =  0f, z = -1.2f },
                    BodyCenter,
                    "ffffff",
                    noHidden: true)
            };
        ...
        public static List<ITriangleMeshWithColorAndTexture>? ParticlesStartGuide()
        {
            ...
            {
                CreateTriangleOutward(
                    new Vector3 { x = tailTipX - 5f, y =  3.5f, z =  0.9f },
                    new Vector3 { x = tailTipX - 5f, y = -3.5f, z =  0.9f },
                    new Vector3 { x = tailTipX - 5f, y =  0f, z = -0.9f },
                    BodyCenter,
                    "ffffff",
                    noHidden: true)
            };
