    ...
    internal static class KamikazeDroneAi
    {
        ...
        internal static _3dObject? GetClosestActiveDecoy(I3dObject currentDrone)
        {
            ...
            for (int i = 0; i < aiObjects.Count; i++)
            {
                ...
                var candidateCenter = KamikazeDroneMovementHelpers.GetNavigationCrashCenterWorldPosition(candidate);
        ...
        internal static Vector3? GetClosestDecoyCrashCenterWorldPosition(I3dObject currentDrone)
        {
            ...
            return closestDecoy == null ? null : KamikazeDroneMovementHelpers.GetNavigationCrashCenterWorldPosition(closestDecoy);
        }
