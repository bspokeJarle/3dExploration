...
public class PowerUpCheckpointPersistenceTests
{
    ...
    public void CollectingPowerUp_SavesCheckpointAndPersistsPowerUpsCollected()
    {
        ...
        var ship = new OmegaObject3D
        {
            ...
            ObjectParts = new List<I3dObjectPart> { new OmegaObjectPart3D { PartName = "Ship", Triangles = new List<ITriangleMeshWithColorAndTexture>() } },
        ...
        var powerUp = new OmegaObject3D
        {
            ...
            ObjectParts = new List<I3dObjectPart> { new OmegaObjectPart3D { PartName = "PowerUp", Triangles = new List<ITriangleMeshWithColorAndTexture>() } },
            Rotation = new Vector3(),
            WorldPosition = new Vector3(),
            ObjectOffsets = new Vector3()
        };
