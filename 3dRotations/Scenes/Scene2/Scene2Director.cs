...
{
    public class Scene2Director : ISceneDirector
    {
        ...
        /// <summary>
        /// Called once per frame by the game loop, after cleanup and before HUD sync.
        /// Checks gameplay conditions and activates the next phase when ready.
        /// </summary>
        public void Update()
        {
        ...
        // -----------------------------------------------------------------
        // Phase: activate kamikaze drones when decoy weapon is unlocked
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // Phase: activate mothership when all seeders and drones are eliminated
        // -----------------------------------------------------------------
        ...
        // -----------------------------------------------------------------
        // Phase: victory when every enemy type is gone
        // -----------------------------------------------------------------
