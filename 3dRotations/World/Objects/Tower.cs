...
namespace _3dRotations.World.Objects
{
    public class Tower
    {
        ...
        private static void AddQuadOutward(
            ...
            string color)
        {
            tris.Add(CreateTriangleOutward(v1, v2, v3, center, color));
            tris.Add(CreateTriangleOutward(v1, v3, v4, center, color));
        }

        // Creates a triangle and guarantees that its normal points outward from the given center.
